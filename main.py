...
if __name__ == '__main__':
    ...
    # UI = GUI.GUI()
    modelidx, model_path, useVid, vid_path = 1, "./tflite_models/openpose_mobilenetv0.75_quant_1x368x368x3.tflite", True, "./datasets/model1_vids/original/jess_IMG_0480.MOV"
